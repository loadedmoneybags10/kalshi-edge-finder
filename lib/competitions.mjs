...
export const COMPETITIONS = {
  // ---- daily driver ----
  mlb:        { sport: "mlb", league: "mlb",        oddsSport: "baseball_mlb",              cadence: "daily",    enabled: true /*, kalshiSeries: "KX..." */ },

  // ---- NFL (moneyline · spread · points O/U) ----
  nfl:        { sport: "nfl", league: "nfl",        oddsSport: "americanfootball_nfl",      cadence: "matchday", enabled: true },
